...
int main(void)
{
	...
	/*irq_timer_arm(&fd.temp_timer.itmr, timer_disarm);
	irq_timer_writel(&fd.temp_timer.itmr, 0x0, TIMER_SEL);
	...
	mprintf("\tSet all output enable stages\n\n");
	irq_timer_arm(&fd.temp_timer.itmr, timer_arm);
