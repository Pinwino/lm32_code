...
#include <linux/math64.h> //<------------------ MOVE TO A MORE APPROPRIATE LOCATION
...
extern int fdelay_config_pulse(int channel, struct fdelay_pulse *pulse);
...
//extern int fdelay_get_config_pulse(int channel, struct fdelay_pulse *pulse);
